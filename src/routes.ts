...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/notes',
            ...
            ...(fetchMiddlewares<RequestHandler>(NotesController.prototype.getNotes)),

            async function NotesController_getNotes(request: ExRequest, response: ExResponse, next: any) {
        ...
        app.delete('/notes/:id',
            ...
            async function NotesController_deleteNote(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    id: {"in":"path","name":"id","required":true,"dataType":"string"},
            };
